...
export class PortfolioComponent {
  ...
  portfolio: { name: string, stack: string, description: string, descriptionDe: string, testlink: string, gitlink: string, img: string }[] = [
    { name: 'DABubble', stack: 'Angular | TypeScript | Firebase | HTML | CSS', description: 'A chat messenger that allows users to send text messages, create threads, and share files.', descriptionDe: 'Ein Chat-Messenger, der es ermöglicht, Textnachrichten zu senden, Threads zu erstellen und Dateien zu teilen.', testlink: 'https://dabubble.wladimir-wagner.com', gitlink: 'https://github.com/WladimirWagner/DABubble', img: './assets/img/projects/dabubble/dabubble.png' },
